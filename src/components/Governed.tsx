  ...
  return (
    <Container classes="flex flex-col lg:flex-row items-center justify-between mt-[6.25rem]">
      <h2 className="text-[1rem] leading-[1.563rem] lg:text-[2.875rem] lg:leading-[3.625rem] font-[300] text-white">
        Governed by
        <span className="text-[1rem] leading-[1.563rem] lg:text-[2.5rem] lg:leading-[3.17rem] font-[700] text-[#FF0083] tracking-[0.125rem]">
          RingDAO
        </span>
      </h2>
      <div className="flex flex-col items-center gap-[1.25rem]">
        <p className="text-[0.875rem] leading-[1.4rem] lg:text-[1.5rem] italic lg:leading-[1.902rem] text-[#F2F3F5] tracking-[0.125rem]">
